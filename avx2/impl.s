...
// func hashF_avx(input *[8192]byte, length uint64, counter uint64, flags uint32, out *[32]uint32, chain *[8]uint32)
// Requires: AVX, AVX2
TEXT ·hashF_avx(SB), $656-48
	MOVQ input+0(FP), AX
	MOVQ length+8(FP), CX
...
// func hashP_avx(left *[32]uint32, right *[32]uint32, flags uint8, out *[32]uint32)
// Requires: AVX, AVX2
TEXT ·hashP_avx(SB), NOSPLIT, $40-32
	MOVQ    left+0(FP), AX
	MOVQ    right+8(FP), CX
...
TEXT ·compress_sse41(SB), NOSPLIT, $0-40
	MOVQ   chain+0(FP), AX
	MOVQ   block+8(FP), CX
	MOVQ   counter+16(FP), DX
	MOVL   blen+24(FP), BX
