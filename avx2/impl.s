...
// func HashF(input *[8192]byte, length uint64, counter uint64, flags uint32, out *[32]uint32, chain *[8]uint32)
// Requires: AVX, AVX2
TEXT ·HashF(SB), $688-48
	MOVQ input+0(FP), AX
	MOVQ length+8(FP), CX
...
// func HashP(left *[32]uint32, right *[32]uint32, flags uint8, out *[32]uint32, n int)
// Requires: AVX, AVX2
TEXT ·HashP(SB), NOSPLIT, $72-40
	MOVQ    left+0(FP), AX
	MOVQ    right+8(FP), CX
